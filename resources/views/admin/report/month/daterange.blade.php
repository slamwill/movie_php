        ...
        <div class="box box-primary">
            ...
            <div class="box-body ">
                ...
                <form class="form-inline" action="{{ URL::current() }}" method="get" pjax-container="" accept-charset="UTF-8">
                        ...
                        <div class="input-group ">
                            <div class="col-lg-6">
                                <select name="group" id="group">
                                    ...
                                    <option value="basic" @if($group == 'basic') selected @endif>基礎</option>
                                    <option value="banner" @if($group == 'banner') selected @endif>廣告</option>
                                    <option value="category" @if($group == 'category') selected @endif>分類</option>
                                    <option value="tag" @if($group == 'tag') selected @endif>標籤</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <button class="btn btn-primary "  type="button" id="btn-cancel" style="margin-left:25px;">清除</button>
                </form>
